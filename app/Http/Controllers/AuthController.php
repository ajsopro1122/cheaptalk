...
class AuthController extends Controller
{
    ...
    public function register(Request $request){
        ...
        Mail::send('verification-email', ['user'=>$user], function($mail) use ($user){
            ...
            $mail->from('alvinjoseorcullo@gmail.com', 'IPT102 Midterm Project');
        });


        return redirect('/login')->with('Message', 'Your account has been created, Please check your gmail for verification');
    }
